...
export class Verifications {
   ...
   */
  postVerificationsApiUserV30VerificationsEmailByEmailAddress(
    emailAddress,
    params = {},
  ) {
    const url = `/api/user/v3.0/verifications/email/${emailAddress}`;
   ...
   * @param {Object} params - additional query params
   */
  postVerificationsApiUserV30VerificationsEmailByTokenByConfirmationCodeComplete(
    token,
    confirmationCode,
    params = {},
  ) {
    const url = `/api/user/v3.0/verifications/email/${token}/${confirmationCode}/complete`;
    return this.client.request("post", url, {}, params);
  }
   ...
   * @param {Object} params - additional query params
   */
  postVerificationsApiUserV30VerificationsMobilephoneByMobilePhoneNumber(
    mobilePhoneNumber,
    params = {},
  ) {
    const url = `/api/user/v3.0/verifications/mobilephone/${mobilePhoneNumber}`;
    return this.client.request("post", url, {}, params);
  }
   ...
   * @param {Object} params - additional query params
   */
  postVerificationsApiUserV30VerificationsMobilephoneByTokenByConfirmationCodeComplete(
    token,
    confirmationCode,
    params = {},
  ) {
    const url = `/api/user/v3.0/verifications/mobilephone/${token}/${confirmationCode}/complete`;
    return this.client.request("post", url, {}, params);
  }

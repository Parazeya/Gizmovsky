...
export class Attributes {
  ...
  Default limit is 10.
         ...
         * @param {string} options.attributeName - Return attributes with names that contain the specified string.
   ...
   * @param {string} data.friendlyName - The friendly name of the attribute.
   * @param {Object} params - additional query params
   */

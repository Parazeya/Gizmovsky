...
export class Auth {
   ...
   * @param {string} options.password - query
   * @param {Object} params - additional query params
   */
  getAuthApiUserV20AuthAccesstoken(options = {}, params = {}) {
   ...
   * @param {Object} options - options object with possible query parameters
   * @param {string} options.token - query
   * @param {string} options.refreshToken - query
   * @param {Object} params - additional query params
   */
  getAuthApiUserV20AuthAccesstokenRefresh(options = {}, params = {}) {

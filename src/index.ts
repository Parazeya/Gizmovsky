import { GizmoClient, type GizmoClientConfig } from "./GizmoClient.js";
// v1
...
import { BanLogs as BanLogsV3 } from './v3/BanLogs.js';
import { BanReasons as BanReasonsV3 } from './v3/BanReasons.js';
...
import { FileImages as FileImagesV3 } from './v3/FileImages.js';
...
import { Integrations as IntegrationsV3 } from './v3/Integrations.js';
...
import { ProductStocks as ProductStocksV3 } from './v3/ProductStocks.js';
...
import { Registrations as RegistrationsV3 } from './v3/Registrations.js';
...
import { StockCounts as StockCountsV3 } from './v3/StockCounts.js';
import { Stocks as StocksV3 } from './v3/Stocks.js';
...
import { VerificationComplete as VerificationCompleteV3 } from './v3/VerificationComplete.js';
import { WaitingLines as WaitingLinesV3 } from './v3/WaitingLines.js';

function createV1Categories(client: GizmoClient) {
  return {
...
function createV2Categories(client: GizmoClient) {
  return {
...
function createV3Categories(client: GizmoClient) {
  return {
    eventStream: (options = {}) => new EventStreamV3(client, options),
    ...
    banLogs: new BanLogsV3(client),
    banReasons: new BanReasonsV3(client),
    ...
    fileImages: new FileImagesV3(client),
    ...
    integrations: new IntegrationsV3(client),
    ...
    productStocks: new ProductStocksV3(client),
    ...
    registrations: new RegistrationsV3(client),
    ...
    stockCounts: new StockCountsV3(client),
    stocks: new StocksV3(client),
    ...
    verificationComplete: new VerificationCompleteV3(client),
...
export class GizmoSDK {
  client: GizmoClient;
  v1: ReturnType<typeof createV1Categories>;
  v2: ReturnType<typeof createV2Categories>;
  v3: ReturnType<typeof createV3Categories>;

  constructor(config: GizmoClientConfig) {
